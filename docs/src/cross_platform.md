...
| `PCLI2_MAX_RETRIES` | Retries for transient failures: connection errors, 408/429/503, and 502/504 for requests that are safe to repeat (not uploads or other requests that create something) (default 2; `0` disables). |
