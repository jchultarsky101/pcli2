        ...
        Some((COMMAND_FOLDER, sub_matches)) => {
            ...
            match sub_matches.subcommand() {
                ...
                Some(("upload", sub_matches)) => {
                    trace!("Command: {} upload", COMMAND_FOLDER);
